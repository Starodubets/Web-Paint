...
var SimpleFigure = {
                                ...
                                <ul class="dropdown-menu">\
                                    ...
                                    <li>\
                                        <label style="padding: 0 20px">Color\
                                            <input id ="coloridM" class="form-control" type="color" value="#563d7c" style="display: inline-block">\
                                        </label>\
                                    </li>\
                                    <li class="dropdown-submenu"><a class="subMenuHeader">Width<span class="caret"></span></a>\
                                        <ul id = "widthidM" class="dropdown-menu">\
                                            <li><a>1</a></li>\
                                            <li><a>5</a></li>\
                                            <li><a>10</a></li>\
                                            <li><a>15</a></li>\
    ...
    getRightToolBox(){
        var rightToolBox = $.parseHTML('\
                            ...
                            <div class="panel-body">\
                                <label>Color</label>\
                                <input class="form-control" type="color" value="#563d7c" style="display: inline-block" onclick="ChangeColor(this.value)" id = "colorp" >\
                            </div>\
                            <div class="panel-body">\
                                <label>Width</label>\
                                <select class="form-control lineWidth" onclick="ChangeWidth(this.value)">\
                                    <option>1</option>\
                                    <option>5</option>\
                                    <option>10</option>\
                                    <option>15</option>\
